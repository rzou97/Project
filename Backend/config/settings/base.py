...
INTELLIGENCE_AUTO_ANALYZE_FAILURES = os.getenv("INTELLIGENCE_AUTO_ANALYZE_FAILURES", "True") == "True"
INTELLIGENCE_ANALYSIS_ASYNC = os.getenv("INTELLIGENCE_ANALYSIS_ASYNC", "True") == "True"
INTELLIGENCE_DEFAULT_MODEL_NAME = os.getenv("INTELLIGENCE_DEFAULT_MODEL_NAME", "history-rules")
INTELLIGENCE_DEFAULT_MODEL_VERSION = os.getenv("INTELLIGENCE_DEFAULT_MODEL_VERSION", "v1")
